...
class WorldFragment : Fragment(), MainAdapter.OnItemClickListener {
...
//        list.add(
//            News(
//                getString(R.string.lorem_ipsum_is_simply_dummy_text_of_the_printing_and_typesetting_industry),
//                R.drawable.ic_ch_logo,
//                getString(R.string.cnn),
//                getString(R.string._11_h),
//                R.drawable.ic_water
//            )
//        )
//
